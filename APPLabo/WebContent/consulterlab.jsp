    ...
    <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              <jsp:include page="./../src/serv/listelabo.java" />
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><c:out value="${labo.id_labo}"/></td>
                  <td><c:out value="${labo.nom}"/></td>
                  <td><c:out value="${labo.email}"/></td>
                  <td><c:forEach items="${region}" var="rg">
                      <c:if test="${labo.id_region==rg.id_region}" >
                      <c:out value="${rg.nom_region}"/>
                      </c:if>
                      </c:forEach>
                  </td>
                   <td>
                    <button class="btn btn-info btn-mini" data-toggle="modal" data-target="#edit" onclick="edit(<c:out value="${labo.id_labo}"/>,'<c:out value="${labo.nom}"/>','<c:out value="${labo.login}"/>','<c:out value="${labo.mdp}"/>','<c:out value="${labo.email}"/>','<c:out value="${labo.id_region}"/>')">
                        <i class="icon-edit"></i></button>
                    <button class="btn btn-danger btn-mini" data-toggle="modal" data-target="#confirm" onclick="change(<c:out value="${labo.id_labo}"/>)"><i class="icon-remove"></i></button>
                  </td>
                </tr>
                </c:forEach>
              </tbody>
